sap.ui.define([
	...
	"use strict";
	var oMockServer,
		_sAppModulePath = "com/sap/web-overview/";
	...
	return {
		...
		init: function () {
			var oUriParameters = new UriParameters(window.location.href),
				...
				sEntity = "",
				//entities = "[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object]",
			...
			for (var property in oDataSources) {
				if (oDataSources.hasOwnProperty(property)) {
					var sDataSource = oDataSources[property],
						sMetadataUrl = sap.ui.require.toUrl(_sAppModulePath + sDataSource.settings.localUri.replace(".xml", "") + ".xml"),
					...
					if (sDataSource.settings && sDataSource.settings.localUri) {
						if (typeof sDataSource.type === "undefined" || sDataSource.type === "OData") {
							...
							var sLocalUri = sap.ui.require.toUrl(_sAppModulePath + sDataSource.settings.localUri.replace(".xml", "") + ".xml");
					...
					aAnnotations.forEach(function (sAnnotationName) {
						...
						var sAnnoUri = oAnnotation.uri,
							sLocalAnnoUri = sap.ui.require.toUrl(_sAppModulePath + oAnnotation.settings.localUri.replace(".xml", "") + ".xml");
